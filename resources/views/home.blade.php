          ...
          <table class="table mb-0">
            <thead class="bg-light">
              <tr>
                ...
                <th scope="col" class="border-0">Status Connect</th>
                <th scope="col" class="border-0"></th>
              </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                      @if($item->koneksi == 'Y')
                        <span class="text-success"><i class="material-icons">check</i> </span>Connected</td>
                      @else
                        <span class="text-danger"><i class="material-icons">close</i> </span>Not Connect</td>
                      @endif
                    <td>
